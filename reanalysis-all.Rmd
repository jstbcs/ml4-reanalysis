...
forest.all(obs.data = dat.211, es.data = m.211, est.averaging = rema.211$est$default, est.multilevel = rean.211$effects)
```

```{r forests-311, fig.width=10, fig.height=9}
forest.all(obs.data = dat.311, es.data = m.311, est.averaging = rema.311$est$default, est.multilevel = rean.311$effects)
```
...
forest.all(obs.data = dat.111, es.data = m.111, est.averaging = rema.111.es$est$default, est.multilevel = rean.111$effects)
```

```{r forests-211-unconstrained, fig.width=10, fig.height=10}
forest.all(obs.data = dat.211, es.data = m.211, est.averaging = rema.211.es$est$default, est.multilevel = rean.211$effects)
```

```{r forests-311-unconstrained, fig.width=10, fig.height=9}
forest.all(obs.data = dat.311, es.data = m.311, est.averaging = rema.311.es$est$default, est.multilevel = rean.311$effects)
```
